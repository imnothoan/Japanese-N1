...
('reading','N3','N3 Reading Skills',600,'[{"id":"q1","prompt":"集合時間は？","options":["6時","7時","8時"],"answer":"7時"}]'::jsonb),
('listening','N2','N2 Listening Focus',600,'[{"id":"q1","prompt":"何を追加しますか？","options":["図表","写真","録音"],"answer":"図表"}]'::jsonb),
('grammar','N1','N1 Advanced Grammar',720,'[{"id":"q1","prompt":"「〜ずにはいられない」の意味として最も近いものは？","options":["必ず成功する","どうしても〜してしまう","許可されている"],"answer":"どうしても〜してしまう"}]'::jsonb)
on conflict do nothing;
